    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 text-center">
        ...
        <p className="text-xl md:text-2xl text-violet-100 mt-8 max-w-4xl mx-auto leading-relaxed">
          UOV Foundation works to empower communities through
          education, healthcare, citizen welfare, environmental
          sustainability, and leadership development. Our initiatives
          are designed to create lasting impact and meaningful social change.
        </p>
