        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center">
              <img
                src="/trustees/murali.jpeg"
                alt="Mr. Muralishankar"
                className="
                  w-full
                  max-w-md
                  rounded-3xl
            ...
            <div>
              <span
                ...
                "
              >
                Trustee - Education & Skill Development
              </span>

              <h1 className="text-5xl md:text-6xl font-bold text-white mt-6">
                Mr. Muralishankar, M.Sc., M.Phil., B.Ed.
              </h1>
              ...
              <p className="text-violet-100 text-lg mt-8 leading-relaxed">
                A committed trustee focused on education, skill development,
                and guidance that helps individuals grow with confidence and
                purpose.
              </p>
